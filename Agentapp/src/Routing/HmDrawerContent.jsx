...
export function HmDrawerContent(props) {
      ...
      >
        ...
        <Drawer.Section style={styles.drawerSection}>
          <DrawerItem
            ...
            onPress={() => {navigation.navigate("hmhome")}}
          />
          <DrawerItem
            icon={({ color, size }) => (
            ...
            label="Projects"
            labelStyle={{fontFamily:fonts.mregular,fontSize:RFPercentage(2.6)}}
            onPress={() => {navigation.navigate(ScreenNames.HmProjects)}}
          />
          <DrawerItem
            icon={({ color, size }) => (
            ...
            label="Message"
            labelStyle={{fontFamily:fonts.mregular,fontSize:RFPercentage(2.6)}}
            onPress={() => {navigation.navigate(ScreenNames.HmMessage)}}
          />
          <DrawerItem
            icon={({ color, size }) => (
            ...
            label="Share Image"
            labelStyle={{fontFamily:fonts.mregular,fontSize:RFPercentage(2.6)}}
            onPress={() => {navigation.navigate(ScreenNames.HmSharePhoto)}}
          />
            <DrawerItem
            icon={({ color, size }) => (
