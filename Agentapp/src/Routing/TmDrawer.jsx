...
import { TmDrawerContent } from './TmDrawerContent';
const Drawer = createDrawerNavigator();

export default function TmDrawer() {
    return (
      <Drawer.Navigator drawerContent={() => <TmDrawerContent />} screenOptions={{headerShown:false}}>
        <Drawer.Screen
        name={"tmhome"}
        component={TmBottomTab}        
      />
      </Drawer.Navigator>
    );
  }